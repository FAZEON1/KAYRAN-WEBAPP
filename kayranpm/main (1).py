                    ...
                    def _kampanya_detay_dialog():
                        ...
                        if k_urunler:
                            ...
                            _metrikler = [
                                ...
                                # Kart artık TOPLAM verilen desteği gösterir (firma + ek);
                                # kırılım alt yazıda. Eskiden yalnız ek destek toplanıyor,
                                # firma destekleri karta hiç yansımıyordu ($0 görünüyordu).
                                {"label": "💸 Toplam Destek Verilen",
                                 "value": f"${toplam_destek_verilen:,.0f}",
                                 "renk": "#FB923C",
                                 "alt": (f"firma ${toplam_destek_verilen - toplam_ek_destek_verilen:,.0f}"
                                         f" + ek ${toplam_ek_destek_verilen:,.0f}")},
                            ]
                            if _spiff_usd_p > 0:
                                _metrikler.append({
